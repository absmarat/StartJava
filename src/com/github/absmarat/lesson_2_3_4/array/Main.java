...
public class Main {
    ...
    private static void calculateFactorial() {
        ...
        int[] numbers1 = null;
        factorials = Arrays.calFctorial(numbers1);
    ...
    private static void createTypewriterEffect() throws InterruptedException {
        String enteredText = "Java - это C++, из которого убрали все пистолеты, ножи и дубинки.\n" +
                "- James Gosling\n";
        String[] modifiedText = Arrays.convertSubstringToUpperCase(enteredText);
        ...
        enteredText = "Чтобы написать чистый код, мы сначала пишем грязный код, затем рефакторим его.\n" +
                "- Robert Martin\n";
        modifiedText = Arrays.convertSubstringToUpperCase(enteredText);
        Console.displayTypewriterEffect(modifiedText);
